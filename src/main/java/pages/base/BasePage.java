...
public class BasePage {
    ...
    private final By mainLogoButton = By.xpath("//a[@class='aqIhT3']");
    private final By headerMenuOpen = By.xpath("//button[@class='zgNcuV js-modal-btn']");
    ...
    private final By getStartedNowInHeaderButton = By.xpath("//a[@class='Hfn1KW-mPSs4 Ddcv5y5jQfZ words chars splitting']");
    ...
    public BasePage headerButtonClick (int numButton) {
        By headerButton = By.xpath("(//a[@class='SDP1l '])[" + numButton + "]");
        driver.findElement(headerButton).click();
        return this;
    }

    public BasePage headerMenuOpen () {
        By headerButton = By.xpath("(//a[@class='SDP1l '])[2]");
    ...
    public BasePage locationButtonClick(int numButton) {
        By footerButton = By.xpath("(//div[@class='rXzLE5W1OUdF'])[" + numButton + "]");
